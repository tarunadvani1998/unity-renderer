...
[System.Serializable]
public class PBRMaterialModel : BaseModel
{
    [Range(0f, 1f)]
    ...
    public override BaseModel GetDataFromJSON(string json) { return Utils.SafeFromJson<PBRMaterialModel>(json); }
    public override bool Equals(object obj)
    {
        ...
        if (obj.GetType() != this.GetType())
            return false;
        return Equals((PBRMaterialModel) obj);
    }

    protected bool Equals(PBRMaterialModel other) { return alphaTest.Equals(other.alphaTest) && albedoColor.Equals(other.albedoColor) && albedoTexture == other.albedoTexture && metallic.Equals(other.metallic) && roughness.Equals(other.roughness) && microSurface.Equals(other.microSurface) && specularIntensity.Equals(other.specularIntensity) && alphaTexture == other.alphaTexture && emissiveTexture == other.emissiveTexture && emissiveColor.Equals(other.emissiveColor) && emissiveIntensity.Equals(other.emissiveIntensity) && reflectivityColor.Equals(other.reflectivityColor) && directIntensity.Equals(other.directIntensity) && bumpTexture == other.bumpTexture && castShadows == other.castShadows && transparencyMode == other.transparencyMode; }
